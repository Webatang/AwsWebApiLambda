...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *AwsWebApiLambda*):
...
Execute unit tests
```
    cd "AwsWebApiLambda/test/AwsWebApiLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "AwsWebApiLambda/src/AwsWebApiLambda"
